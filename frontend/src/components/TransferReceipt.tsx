...
export function TransferReceiptCard({ receipt }: Props) {
  return (
      ...
      <div className="mb-4 rounded-xl bg-white/[0.04] border border-white/[0.06] p-4">
        <div className="text-center space-y-1">
          ...
          <p className="text-lg font-bold text-white">
            {receipt.amount} <span className="text-white/50">{receipt.token}</span>
          </p>
        </div>
        ...
        <div className="text-center space-y-1">
          <p className="text-[11px] font-medium uppercase tracking-wider text-white/30">To</p>
